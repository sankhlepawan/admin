...
@AllArgsConstructor
@NoArgsConstructor
public class PlaceOrderOneTimeInput {
...
private LocaleConfig localeConfig;
	...
	public String validate(Locale locale) {
		...
		String error = null;
		Set<ConstraintViolation<PlaceOrderOneTimeInput>> violations = validator.validate(this);
		for (ConstraintViolation<PlaceOrderOneTimeInput> violation : violations) {
